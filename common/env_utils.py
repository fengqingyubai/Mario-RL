...
class CustomReward(gym.Wrapper):
    def __init__(self, env, world, stage):
        super().__init__(env)
...
# --- 3. 环境生成工厂 ---
def get_vec_env(world, stage, num_envs=8):
    """
    根据传入的 world 和 stage 生成对应的训练环境
    例如: SuperMarioBros-1-1-v0
    """
    # 构造特定关卡 ID
    ...
    def make_env():
        ...
        # 依然使用 SIMPLE_MOVEMENT (如果有些关卡必须进管道，请改回 COMPLEX_MOVEMENT)
    ...
    env = VecMonitor(env) # 必须有，SwanLab 才能读到数据
